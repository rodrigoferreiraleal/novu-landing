export default async function handler(req, res) {
  ...
  const response = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      max_tokens: 1000,
      system: `És a NOVU, uma assistente especializada em burocracia portuguesa para imigrantes.
...
- Sê calorosa, próxima e encorajadora
...
- Nunca dás aconselhamento jurídico
